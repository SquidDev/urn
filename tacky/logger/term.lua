...
printExplain_21_1 = (function(explain1, lines3)
	if explain1 then
		local r_1471 = split1(lines3, "\n")
		local r_1501 = _23_1(r_1471)
		local r_1481 = nil
		r_1481 = (function(r_1491)
			if (r_1491 <= r_1501) then
				local line1 = r_1471[r_1491]
