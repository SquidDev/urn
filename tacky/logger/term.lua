...
printExplain_21_1 = (function(explain1, lines3)
	if explain1 then
		local r_1491 = split1(lines3, "\n")
		local r_1521 = _23_1(r_1491)
		local r_1501 = nil
		r_1501 = (function(r_1511)
			if (r_1511 <= r_1521) then
				local line1 = r_1491[r_1511]
