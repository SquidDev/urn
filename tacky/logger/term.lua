...
printExplain_21_1 = (function(explain1, lines3)
	if explain1 then
		local r_1511 = split1(lines3, "\n")
		local r_1541 = _23_1(r_1511)
		local r_1521 = nil
		r_1521 = (function(r_1531)
			if (r_1531 <= r_1541) then
				local line1 = r_1511[r_1531]
