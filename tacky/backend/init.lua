						...
						r_1331 = (function(r_1341)
							if (r_1341 <= r_1351) then
								...
								if temp7 then
									...
									line_21_1(out4)
									line_21_1(out4, _2e2e_1("for _c = 1, _temp.n do _result[", tostring1((r_1341 - offset1)), " + _c + _offset] = _temp[_c] end"))
									line_21_1(out4, "_offset = _offset + _temp.n")
								else
									append_21_1(out4, _2e2e_1("_result[", tostring1((r_1341 - offset1)), " + _offset] = "))
	...
	if list_3f_1(node4) then
		...
		if symbol_3f_1(head1) then
						...
						if (variadic1 == _23_1(args2)) then
							...
							r_1611 = (function(r_1621)
								if (r_1621 <= r_1631) then
									append_21_1(out5, ", ")
									append_21_1(out5, escapeVar1(args2[r_1621]["var"], state3))
							...
							r_1651 = (function(r_1661)
								if (r_1661 <= r_1671) then
									append_21_1(out5, escapeVar1(args2[r_1661]["var"], state3))
							...
							r_1691 = (function(r_1701)
								if (r_1701 <= r_1711) then
									append_21_1(out5, escapeVar1(args2[r_1701]["var"], state3))
					...
					if temp11 then
						...
						r_1811 = (function(r_1821)
							if (r_1821 <= count1) then
								...
								append_21_1(out5, _2e2e_1("v", tonumber1(r_1821)))
			...
			elseif (var2 == builtins1["import"]) then
				...
				local meta3
				local r_2021 = symbol_3f_1(head1)
				if r_2021 then
					local r_2031 = (head1["var"]["tag"] == "native")
					if r_2031 then
				...
				if temp12 then
					...
					r_1981 = (function(r_1991)
						if (r_1991 <= r_2001) then
							...
							compileExpression1(nth1(node4, r_1991), out5, state3)
			...
			local r_2041 = ret1
			if r_2041 then
				local r_2051 = list_3f_1(head1)
				if r_2051 then
					local r_2061 = symbol_3f_1(car2(head1))
					if r_2061 then
			...
			if temp15 then
						...
						if var4["isVariadic"] then
							...
							r_2111 = (function(r_2121)
								if (r_2121 <= r_2131) then
									append_21_1(out5, ", ")
									compileExpression1(nth1(node4, (r_2081 + r_2121)), out5, state3)
				...
				r_2151 = (function(r_2161)
					if (r_2161 <= r_2171) then
						compileExpression1(nth1(node4, r_2161), out5, state3, "")
						line_21_1(out5)
				...
				r_2191 = (function(r_2201)
					if (r_2201 <= r_2211) then
						...
						compileExpression1(nth1(node4, r_2201), out5, state3)
...
compileBlock1 = (function(nodes1, out6, state4, start1, ret3)
	...
	r_1151 = (function(r_1161)
		if (r_1161 <= r_1171) then
			...
			compileExpression1(nth1(nodes1, r_1161), out6, state4, ret_27_1)
			line_21_1(out6)
			return r_1151((r_1161 + 1))
		else
		end
	end)
	return r_1151(start1)
end)
...
estimateLength1 = (function(node5, max1)
	...
	local temp16
	local r_2231 = (tag2 == "string")
	if r_2231 then
		temp16 = r_2231
	else
		local r_2241 = (tag2 == "number")
		if r_2241 then
			temp16 = r_2241
		else
			local r_2251 = (tag2 == "symbol")
			if r_2251 then
				temp16 = r_2251
			else
				temp16 = (tag2 == "key")
...
formatSignature1 = (function(name4, var7)
	...
	elseif nil_3f_1(sig1) then
		...
		return _2e2e_1("(", name4, " ", concat1(traverse1(sig1, (function(r_2541)
			return r_2541["contents"]
		end)), " "), ")")
	end
end)
exported1 = (function(out9, title1, primary1, vars1)
	...
	line_21_1(out9, "---")
	line_21_1(out9, _2e2e_1("title: ", title1))
	line_21_1(out9, "---")
	line_21_1(out9, _2e2e_1("# ", title1))
	if primary1 then
		line_21_1(out9, primary1)
	else
	end
	local r_2591 = _23_1(documented1)
	local r_2571 = nil
	r_2571 = (function(r_2581)
		if (r_2581 <= r_2591) then
			local entry5 = documented1[r_2581]
			local name6 = car2(entry5)
			local var9 = nth1(entry5, 2)
			line_21_1(out9, _2e2e_1("## `", formatSignature1(name6, var9), "`"))
			line_21_1(out9, _2e2e_1("*", formatDefinition1(var9), "*"))
			line_21_1(out9, "", true)
			local r_2621 = parseDocstring1(var9["doc"])
			local r_2651 = _23_1(r_2621)
			local r_2631 = nil
			r_2631 = (function(r_2641)
				if (r_2641 <= r_2651) then
					local tok2 = r_2621[r_2641]
					...
					elseif (ty6 == "link") then
						...
						if ovar1 then
							...
							local r_2701
							local r_2691
							local r_2681 = ovar1["node"]
							r_2691 = getSource1(r_2681)
							r_2701 = r_2691["name"]
							r_2711 = gsub1(r_2701, "%.lisp$", "")
							loc1 = gsub1(r_2711, "/", ".")
							...
							elseif nil_3f_1(sig2) then
								...
								hash1 = _2e2e_1(name7, " ", concat1(traverse1(sig2, (function(r_2671)
									return r_2671["contents"]
								end)), " "))
							end
							append_21_1(out9, format1("[`%s`](%s.md#%s)", name7, loc1, gsub1(hash1, "%A+", "-")))
						else
							append_21_1(out9, format1("`%s`", name7))
						end
					else
						_error("unmatched item")
					end
	...
	if nil_3f_1(undocumented1) then
		...
		line_21_1(out9, "## Undocumented symbols")
	end
	local r_2761 = _23_1(undocumented1)
	local r_2741 = nil
	r_2741 = (function(r_2751)
		if (r_2751 <= r_2761) then
			local entry6 = undocumented1[r_2751]
			local name8 = car2(entry6)
			local var10 = nth1(entry6, 2)
			line_21_1(out9, _2e2e_1(" - `", formatSignature1(name8, var10), "` *", formatDefinition1(var10), "*"))
