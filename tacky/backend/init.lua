...
escape1 = (function(name1)
	...
	elseif find1(name1, "^%w[_%w%d]*$") then
		...
		local temp5
		local r_2001
		r_2001 = charAt1(name1, 1)
		temp5 = find1(r_2001, "%d")
		if temp5 then
			out3 = "_e"
		else
			out3 = ""
		...
		local upper2 = false
		local esc1 = false
		local r_1681 = len1(name1)
		local r_1661 = nil
		r_1661 = (function(r_1671)
			if (r_1671 <= r_1681) then
				local char2 = charAt1(name1, r_1671)
				local temp6
				local r_1701 = (char2 == "-")
				if r_1701 then
					local r_1711
					local r_1961
					r_1961 = charAt1(name1, pred1(r_1671))
					r_1711 = find1(r_1961, "[%a%d']")
					if r_1711 then
						local r_1941
						r_1941 = charAt1(name1, succ1(r_1671))
						temp6 = find1(r_1941, "[%a%d']")
					else
						temp6 = r_1711
					end
				else
...
truthy_3f_1 = (function(node6)
	local r_1611 = symbol_3f_1(node6)
	if r_1611 then
...
compileQuote1 = (function(node7, out4, state2, level1)
	if (level1 == 0) then
		...
		elseif (ty2 == "list") then
			...
			if r_1721 then
				local r_1731 = (first2["var"] == builtins1["unquote"])
				if r_1731 then
					temp7 = r_1731
				else
			...
			if temp7 then
				...
				local temp8
				local r_1751 = symbol_3f_1(first2)
				if r_1751 then
				...
				if temp8 then
					...
					local r_1811 = _23_1(node7)
					local r_1791 = nil
					r_1791 = (function(r_1801)
						if (r_1801 <= r_1811) then
							local sub2 = node7[r_1801]
							local temp9
							local r_1831 = list_3f_1(sub2)
							if r_1831 then
								local r_1841 = symbol_3f_1(car2(sub2))
								if r_1841 then
					...
					if containsUnsplice1 then
						...
						local r_1871 = _23_1(node7)
						local r_1851 = nil
						r_1851 = (function(r_1861)
							if (r_1861 <= r_1871) then
								local sub3 = nth1(node7, r_1861)
								local temp10
								local r_1891 = list_3f_1(sub3)
								if r_1891 then
									local r_1901 = symbol_3f_1(car2(sub3))
									if r_1901 then
								...
								if temp10 then
									...
									line_21_1(out4)
									line_21_1(out4, _2e2e_1("for _c = 1, _temp.n do _result[", tostring1((r_1861 - offset1)), " + _c + _offset] = _temp[_c] end"))
									line_21_1(out4, "_offset = _offset + _temp.n")
								else
									append_21_1(out4, _2e2e_1("_result[", tostring1((r_1861 - offset1)), " + _offset] = "))
						...
						local r_2051 = _23_1(node7)
						local r_2031 = nil
						r_2031 = (function(r_2041)
							if (r_2041 <= r_2051) then
								local sub4 = node7[r_2041]
								append_21_1(out4, ", ")
	...
	if list_3f_1(node8) then
		...
		if symbol_3f_1(head1) then
				...
				if (ret1 == "") then
					...
					if variadic1 then
						...
						if (variadic1 == _23_1(args2)) then
							...
							local r_2171 = _23_1(args2)
							local r_2151 = nil
							r_2151 = (function(r_2161)
								if (r_2161 <= r_2171) then
									append_21_1(out5, escapeVar1(args2[r_2161]["var"], state3))
									if (r_2161 < _23_1(args2)) then
										append_21_1(out5, ", ")
									else
									end
				...
				elseif (ty3 == "var") then
					...
					if temp14 then
						...
						r_2271 = (function(r_2281)
							if (r_2281 <= count1) then
								if (r_2281 == 1) then
								else
									append_21_1(out5, ", ")
								end
								append_21_1(out5, _2e2e_1("v", tonumber1(r_2281)))
			...
			elseif (var2 == builtins1["import"]) then
				...
				local meta3
				local r_2481 = symbol_3f_1(head1)
				if r_2481 then
					local r_2491 = (head1["var"]["tag"] == "native")
					if r_2491 then
				...
				if temp15 then
					...
					local r_2411 = _23_1(contents2)
					local r_2391 = nil
					r_2391 = (function(r_2401)
						if (r_2401 <= r_2411) then
							local entry3 = nth1(contents2, r_2401)
					...
					r_2441 = (function(r_2451)
						if (r_2451 <= r_2461) then
							...
							compileExpression1(nth1(node8, r_2451), out5, state3)
			...
			local r_2501 = ret1
			if r_2501 then
				local r_2511 = list_3f_1(head1)
				if r_2511 then
					local r_2521 = symbol_3f_1(car2(head1))
					if r_2521 then
			...
			if temp18 then
				...
				local offset2 = 1
				local r_2551 = _23_1(args3)
				local r_2531 = nil
				r_2531 = (function(r_2541)
					if (r_2541 <= r_2551) then
						local var4 = args3[r_2541]["var"]
						...
						if var4["isVariadic"] then
							...
							r_2571 = (function(r_2581)
								if (r_2581 <= r_2591) then
									append_21_1(out5, ", ")
									compileExpression1(nth1(node8, (r_2541 + r_2581)), out5, state3)
							...
							local expr2 = nth1(node8, (r_2541 + offset2))
				...
				r_2651 = (function(r_2661)
					if (r_2661 <= r_2671) then
						...
						compileExpression1(nth1(node8, r_2661), out5, state3)
...
compileBlock1 = (function(nodes1, out6, state4, start1, ret3)
	local r_1641 = _23_1(nodes1)
	local r_1621 = nil
	r_1621 = (function(r_1631)
		if (r_1631 <= r_1641) then
			local ret_27_1
			if (r_1631 == _23_1(nodes1)) then
				ret_27_1 = ret3
			else
				ret_27_1 = ""
			end
			compileExpression1(nth1(nodes1, r_1631), out6, state4, ret_27_1)
			line_21_1(out6)
...
estimateLength1 = (function(node9, max1)
	...
	local temp19
	local r_2691 = (tag2 == "string")
	if r_2691 then
		temp19 = r_2691
	else
		local r_2701 = (tag2 == "number")
		if r_2701 then
			temp19 = r_2701
		else
			local r_2711 = (tag2 == "symbol")
			if r_2711 then
				temp19 = r_2711
			else
				temp19 = (tag2 == "key")
...
expression1 = (function(node10, writer11)
	...
	elseif (tag3 == "list") then
		...
		if nil_3f_1(node10) then
			...
			local r_2821 = _23_1(node10)
			local r_2801 = nil
			r_2801 = (function(r_2811)
				if (r_2811 <= r_2821) then
					local entry4 = nth1(node10, r_2811)
					local temp21
					local r_2841 = _21_1(newline1)
					if r_2841 then
						temp21 = (max2 > 0)
					else
						temp21 = r_2841
...
block1 = (function(list2, writer12)
	local r_2781 = _23_1(list2)
	local r_2761 = nil
	r_2761 = (function(r_2771)
		if (r_2771 <= r_2781) then
			local node11 = list2[r_2771]
...
extractSignature1 = (function(var5)
	...
	if temp22 then
		...
		local temp23
		local r_2921 = list_3f_1(node12)
		if r_2921 then
			local r_2931 = symbol_3f_1(car2(node12))
			if r_2931 then
			...
			elseif (ty6 == "link") then
				...
				if temp25 then
					...
					elseif nil_3f_1(sig2) then
						...
						hash1 = _2e2e_1(name5, " ", concat1(traverse1(sig2, (function(r_3041)
...
exported1 = (function(out10, title1, primary1, vars1, scope2)
	...
	local r_3131 = _23_1(documented1)
	local r_3111 = nil
	r_3111 = (function(r_3121)
		if (r_3121 <= r_3131) then
			local entry5 = documented1[r_3121]
	...
	local r_3191 = _23_1(undocumented1)
	local r_3171 = nil
	r_3171 = (function(r_3181)
		if (r_3181 <= r_3191) then
			local entry6 = undocumented1[r_3181]
