...
invokable_3f_1 = (function(x12)
	local r_891 = function_3f_1(x12)
	if r_891 then
		return r_891
	else
		local r_901 = table_3f_1(x12)
		if r_901 then
			local r_911 = table_3f_1(getmetatable1(x12))
			if r_911 then
...
putExplain_21_1 = (function(...)
	...
	if showExplain1["value"] then
		local r_1131 = _23_1(lines3)
		local r_1111 = nil
		r_1111 = (function(r_1121)
			if (r_1121 <= r_1131) then
				local line1 = lines3[r_1121]
...
hexDigit_3f_1 = (function(char2)
	local r_931 = between_3f_1(char2, "0", "9")
	if r_931 then
		return r_931
	else
		local r_941 = between_3f_1(char2, "a", "f")
		if r_941 then
			return r_941
		else
					...
					if (char7 ~= "\"") then
						...
						elseif (char7 == "\\") then
							...
							elseif (char7 == "\\") then
								...
								local temp18
								local r_1381 = (char7 == "x")
								if r_1381 then
									temp18 = r_1381
								else
									local r_1391 = (char7 == "X")
									if r_1391 then
										temp18 = r_1391
									else
...
parse1 = (function(toks1)
	...
	r_1431 = (function(r_1441)
		if (r_1441 <= r_1451) then
			...
			local temp23
			local r_1491 = (tag4 == "string")
			if r_1491 then
				temp23 = r_1491
			else
				local r_1501 = (tag4 == "number")
				if r_1501 then
					temp23 = r_1501
				else
					local r_1511 = (tag4 == "symbol")
					if r_1511 then
						temp23 = r_1511
					else
						temp23 = (tag4 == "key")
			...
			elseif (tag4 == "close") then
				...
				local temp24
				local r_1521 = (tag4 == "quote")
				if r_1521 then
					temp24 = r_1521
				else
					local r_1531 = (tag4 == "unquote")
					if r_1531 then
						temp24 = r_1531
					else
						local r_1541 = (tag4 == "quasiquote")
						if r_1541 then
							temp24 = r_1541
						else
							temp24 = (tag4 == "unquote-splice")
						end
					end
				end
				if temp24 then
