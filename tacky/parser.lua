...
lex1 = (function(str2, name2)
	...
	local range3 = (function(start2, finish1)
		return struct1("start", start2, "finish", (function(r_1601)
			if r_1601 then
				return r_1601
			else
				return start2
...
parse1 = (function(toks1)
	...
	r_1261 = (function(r_1271)
		if (r_1271 <= r_1281) then
			...
			local temp19
			local r_1321 = (tag3 == "string")
			if r_1321 then
				temp19 = r_1321
			else
				local r_1331 = (tag3 == "number")
				if r_1331 then
					temp19 = r_1331
				else
					local r_1341 = (tag3 == "symbol")
					if r_1341 then
						temp19 = r_1341
					else
						temp19 = (tag3 == "key")
			...
			elseif (tag3 == "close") then
				...
				local temp20
				local r_1351 = (tag3 == "quote")
				if r_1351 then
					temp20 = r_1351
				else
					local r_1361 = (tag3 == "unquote")
					if r_1361 then
						temp20 = r_1361
					else
						local r_1371 = (tag3 == "quasiquote")
						if r_1371 then
							temp20 = r_1371
						else
