...
doNodeError_21_1 = (function(logger7, msg7, node3, explain3, ...)
	...
	return fail_21_1((function(r_1631)
		if r_1631 then
			return r_1631
		else
			return msg7
...
hexDigit_3f_1 = (function(char2)
	local r_1511 = between_3f_1(char2, "0", "9")
	if r_1511 then
		return r_1511
	else
		local r_1521 = between_3f_1(char2, "a", "f")
		if r_1521 then
			return r_1521
		else
					...
					if (char7 ~= "\"") then
						...
						elseif (char7 == "\\") then
							...
							elseif (char7 == "\\") then
								...
								local temp11
								local r_1811 = (char7 == "x")
								if r_1811 then
									temp11 = r_1811
								else
									local r_1821 = (char7 == "X")
									if r_1821 then
										temp11 = r_1821
									else
...
parse1 = (function(logger10, toks1)
	...
	r_1861 = (function(r_1871)
		if (r_1871 <= r_1881) then
			...
			local temp16
			local r_1951 = (tag3 == "string")
			if r_1951 then
				temp16 = r_1951
			else
				local r_1961 = (tag3 == "number")
				if r_1961 then
					temp16 = r_1961
				else
					local r_1971 = (tag3 == "symbol")
					if r_1971 then
						temp16 = r_1971
					else
						temp16 = (tag3 == "key")
			...
			elseif (tag3 == "close") then
				...
				local temp17
				local r_1981 = (tag3 == "quote")
				if r_1981 then
					temp17 = r_1981
				else
					local r_1991 = (tag3 == "unquote")
					if r_1991 then
						temp17 = r_1991
					else
						local r_2001 = (tag3 == "syntax-quote")
						if r_2001 then
							temp17 = r_2001
						else
							local r_2011 = (tag3 == "unquote-splice")
							if r_2011 then
								temp17 = r_2011
							else
