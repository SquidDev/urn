...
parse1 = (function(toks1)
	...
	r_1421 = (function(r_1431)
		if (r_1431 <= r_1441) then
			...
			local temp21
			local r_1461 = (tag4 ~= "eof")
			if r_1461 then
				local r_1471 = (tag4 ~= "close")
				if r_1471 then
					if head2["range"] then
			...
			local temp22
			local r_1481 = (tag4 == "string")
			if r_1481 then
				temp22 = r_1481
			else
				local r_1491 = (tag4 == "number")
				if r_1491 then
					temp22 = r_1491
				else
					local r_1501 = (tag4 == "symbol")
					if r_1501 then
						temp22 = r_1501
					else
						temp22 = (tag4 == "key")
			...
			elseif (tag4 == "close") then
				...
				local temp23
				local r_1511 = (tag4 == "quote")
				if r_1511 then
					temp23 = r_1511
				else
					local r_1521 = (tag4 == "unquote")
					if r_1521 then
						temp23 = r_1521
					else
						local r_1531 = (tag4 == "quasiquote")
						if r_1531 then
							temp23 = r_1531
						else
