			...
			if (function(r_921)
				...
				elseif _e_61_1(_eget_45_idx1(first1, "contents"), "quasiquote") then
					...
					r_1001 = (function(r_1011)
						local _temp
						if _e_60_1(0, 1) then
							_temp = _e_60__61_1(r_1011, r_1021)
						else
							_temp = _e_62__61_1(r_1011, r_1021)
						end
						if _temp then
							local r_981
							r_981 = r_1011
							local sub2
							sub2 = _eget_45_idx1(r_991, r_981)
							_evisit_45_quote1(sub2, visitor1, level1)
							return r_1001(_e_43_1(r_1011, r_1031))
						else
						end
					end);
					return r_1001(1)
				...
				r_1061 = (function(r_1071)
					local _temp
					if _e_60_1(0, 1) then
						_temp = _e_60__61_1(r_1071, r_1081)
					else
						_temp = _e_62__61_1(r_1071, r_1081)
					end
					if _temp then
						local r_1041
						r_1041 = r_1071
						local sub3
						sub3 = _eget_45_idx1(r_1051, r_1041)
						_evisit_45_quote1(sub3, visitor1, level1)
						return r_1061(_e_43_1(r_1071, r_1091))
					else
					end
				end);
				return r_1061(1)
...
_evisit_45_block1 = (function(node3, start3, visitor3)
	...
	r_851 = (function(r_861)
		local _temp
		if _e_60_1(0, 1) then
			_temp = _e_60__61_1(r_861, r_871)
		else
			_temp = _e_62__61_1(r_861, r_871)
		end
		if _temp then
			local i4
			i4 = r_861
			_evisit_45_node1(nth1(node3, i4), visitor3)
			return r_851(_e_43_1(r_861, r_881))
		else
		end
	end);
	return r_851(start3)
