...
visitQuote1 = (function(node1, visitor1, level1)
	if (level1 == 0) then
		...
		local temp3
		local r_1121 = (tag3 == "string")
		if r_1121 then
			temp3 = r_1121
		else
			local r_1131 = (tag3 == "number")
			if r_1131 then
				temp3 = r_1131
			else
				local r_1141 = (tag3 == "key")
				if r_1141 then
					temp3 = r_1141
				else
					temp3 = (tag3 == "symbol")
		...
		elseif (tag3 == "list") then
			...
			if temp4 then
				...
				elseif (first1["contents"] == "quasiquote") then
					...
					local r_1211 = _23_1(node1)
					local r_1191 = nil
					r_1191 = (function(r_1201)
						if (r_1201 <= r_1211) then
							local sub2 = node1[r_1201]
				...
				local r_1271 = _23_1(node1)
				local r_1251 = nil
				r_1251 = (function(r_1261)
					if (r_1261 <= r_1271) then
						local sub3 = node1[r_1261]
						visitQuote1(sub3, visitor1, level1)
						return r_1251((r_1261 + 1))
					else
					end
				end)
				return r_1251(1)
...
visitNode1 = (function(node2, visitor2)
	if (visitor2(node2, visitor2) == false) then
		...
		local temp6
		local r_1291 = (tag4 == "string")
		if r_1291 then
			temp6 = r_1291
		else
			local r_1301 = (tag4 == "number")
			if r_1301 then
				temp6 = r_1301
			else
				local r_1311 = (tag4 == "key")
				if r_1311 then
					temp6 = r_1311
				else
					temp6 = (tag4 == "symbol")
...
visitBlock1 = (function(node3, start2, visitor3)
	...
	r_1081 = (function(r_1091)
		if (r_1091 <= r_1101) then
			visitNode1(nth1(node3, r_1091), visitor3)
			return r_1081((r_1091 + 1))
		else
		end
	end)
	return r_1081(start2)
end)
...
definitionsVisitor1 = (function(state5, node7, visitor4)
	...
	if temp10 then
		...
		elseif (func2 == builtins2["set!"]) then
			...
			local temp11
			local r_1041 = (func2 == builtins2["define"])
			if r_1041 then
				temp11 = r_1041
			else
		...
		if r_1051 then
			local r_1061 = list_3f_1(car2(node7))
			if r_1061 then
				local r_1071 = symbol_3f_1(caar1(node7))
				if r_1071 then
		...
		if temp12 then
			...
			r_1401 = (function(r_1411)
				if (r_1411 <= r_1421) then
					local arg2 = nth1(args2, r_1411)
					local val4 = nth1(node7, (r_1411 + offset1))
...
definitionsVisit1 = (function(state6, nodes1)
	return visitBlock1(nodes1, 1, (function(r_1521, r_1531)
		return definitionsVisitor1(state6, r_1521, r_1531)
	end))
end)
usagesVisit1 = (function(state7, nodes2, pred2)
	...
	local r_1491 = _23_1(nodes2)
	local r_1471 = nil
	r_1471 = (function(r_1481)
		if (r_1481 <= r_1491) then
			local node9 = nodes2[r_1481]
...
putExplain_21_1 = (function(...)
	...
	if showExplain1["value"] then
		local r_1671 = _23_1(lines3)
		local r_1651 = nil
		r_1651 = (function(r_1661)
			if (r_1661 <= r_1671) then
				local line1 = lines3[r_1661]
...
sideEffect_3f_1 = (function(node15)
	...
	local temp24
	local r_931 = (tag5 == "number")
	if r_931 then
		temp24 = r_931
	else
		local r_941 = (tag5 == "string")
		if r_941 then
			temp24 = r_941
		else
			local r_951 = (tag5 == "key")
			if r_951 then
				temp24 = r_951
			else
				temp24 = (tag5 == "symbol")
	...
	elseif (tag5 == "list") then
		...
		if (type1(fst1) == "symbol") then
			local var5 = fst1["var"]
			local r_961 = (var5 ~= builtins3["lambda"])
			if r_961 then
		...
		elseif (_23_keys1(var6["defs"]) ~= 1) then
			...
			if (defData1["tag"] == "arg") then
				...
				if symbol_3f_1(def2) then
					...
					local temp25
					local r_1791 = list_3f_1(def2)
					if r_1791 then
						local r_1801 = symbol_3f_1(car2(def2))
						if r_1801 then
