...
extractSignature1 = (function(var1)
	...
	if temp1 then
		...
		local temp2
		local r_1421 = list_3f_1(node1)
		if r_1421 then
			local r_1431 = symbol_3f_1(car2(node1))
			if r_1431 then
