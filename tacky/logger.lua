...
putExplain_21_1 = (function(...)
	...
	if showExplain1["value"] then
		local r_1041 = _23_1(lines3)
		local r_1021 = nil
		r_1021 = (function(r_1031)
			if (r_1031 <= r_1041) then
				local line1 = lines3[r_1031]
