...
split1 = (function(text1, pattern1, limit1)
	...
	r_601 = (function()
		if loop1 then
			...
			local _temp
			local r_611 = ("nil" == type_23_1(pos1))
			if r_611 then
				_temp = r_611
			else
				local r_621 = limit1
