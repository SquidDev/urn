...
(define-native add-categoriser
  "Register a custom CATEGORISER. Optionally specify a single backend to register for.
   ...
   If it can handle this node, you should return the result of [[cat]], with
   optional flags specified, otherwise you should return nil. Note, [[cat]] can
   ...
   handle them. Visiting is done using [[categorise-node]].")
...
(define-native add-emitter
  "Register an EMITTER for the specified CATEGORY.
   ...
   emitting child nodes with [[emit-block]] and [[emit-node]].
